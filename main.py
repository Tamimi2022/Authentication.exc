...
def dashboard():
    if 'username' in session:
        bonus_words = ['application', 'association', 'bark', 'anchor', 'authority', 'business', 'class', 'clap']
        return render_template('dashboared.html', username=session['username'], words=bonus_words)
    else:
